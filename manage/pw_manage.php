...
<body>
									...
									<div id="edit" class="tab-pane active">
										...
										<form class="form-horizontal" id="sample-form">
											<div class="form-group">
												<label for="old_pw" class="col-xs-12 col-sm-3 control-label no-padding-right">原密码</label>

												<div class="col-xs-12 col-sm-5 inline help-block">
													<span class="block input-icon input-icon-right">
														<input type="password" name="old_pw" id="old_pw" class="width-100">
														<i class="icon-leaf"></i>
													</span>
												</div>
											...
											<div class="form-group">
												<label for="new_pw" class="col-xs-12 col-sm-3 control-label no-padding-right">新密码</label>

												<div class="col-xs-12 col-sm-5 inline help-block">
													<span class="block input-icon input-icon-right">
														<input type="password" name="new_pw" id="new_pw" class="width-100">
														<i class="icon-leaf"></i>
													</span>
												</div>
												<div class="help-block col-xs-12 col-sm-reset inline red">
											...
											<div class="form-group">
												<label for="new_pw2" class="col-xs-12 col-sm-3 control-label no-padding-right">重复密码</label>

												<div class="col-xs-12 col-sm-5 inline help-block">
													<span class="block input-icon input-icon-right">
														<input type="password" name="new_pw2" id="new_pw2" class="width-100">
														<i class="icon-leaf"></i>
													</span>
												</div>
												<div class="help-block col-xs-12 col-sm-reset inline red">
	...
	<script type="text/javascript">
		function save() {
			$('#loading').modal('show');
			$.post('/ajax/m_pw_manage.php',$('form').serialize(),function(res){
				if (res.tag > 0) {
					$('#loading').modal('hide');
					$('#alert').html(res.html);
					return false;
					...
					setTimeout(function(){
						$('#loading').modal('hide');
						$('#login').text('成功');
						window.location.href="../login_manage.php";
					},1000);
				}
			},'json');
			return false;
