							...
							<div class="tabbable">
								...
								<div class="tab-content">
									<div id="lists" class="tab-pane in active">
										<div id="alert"></div>
										<form class="form-horizontal" id="sample-form" enctype="multipart/form-data">
											...
											<div class="form-group">
												...
												<div class="col-xs-12 col-sm-8 inline help-block">
													<span class="block input-icon input-icon-right">
														<!-- 加载编辑器的容器 -->
														<script id="container" name="cont" type="text/plain"></script>
														<!-- 实例化编辑器 -->
														<script type="text/javascript">
	                ...
	                success: function(res){
	                	...
	                	if (res.tag > 0) {
	                		...
	                		setTimeout(function(){
	                			$('#loading').modal('hide');
	                			$('#login').text('成功');
	                			window.location.href="/manage/list-add.php?id=<?php echo $id;?>&up_id=<?php echo $up_id;?>";
	                		},1000);
	                	}
	                }
	            });
