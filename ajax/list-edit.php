...
$mysql -> update("conts",$data,"id={$cont_id}");

// 上传图片（如果有）
if (isset($data2)) {
    $data2['content_id'] = $cont_id;
    $data2['created_at'] = $time;
    $data2['add_user'] = $_SESSION['super']['name'];
