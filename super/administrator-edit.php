...
<body>
									...
									<div id="edit" class="tab-pane active">
										...
										<form class="form-horizontal" id="sample-form">
											...
											<div class="form-group">
												...
												<div class="col-xs-12 col-sm-5 inline help-block">
													<span class="block input-icon input-icon-right">
														<input type="text" name="real_name" id="real_name" class="width-100" value="<?php echo $row['real_name']?>">
														<i class="icon-leaf"></i>
													</span>
												</div>
											...
											<div class="form-group">
												...
												<div class="col-xs-12 col-sm-5 inline help-block">
													<span class="block input-icon input-icon-right">
														<input type="password" name="password" id="password" class="width-100" placeholder="如果不填写，默认为123456" value="<?php echo $row['password']?>">
														<i class="icon-leaf"></i>
													</span>
												</div>
												<div class="help-block col-xs-12 col-sm-reset inline">
											...
											<div class="form-group">
												...
												<div class="col-xs-12 col-sm-5 inline help-block">
													<span class="block input-icon input-icon-right">
														<input type="text" name="remark" id="remark" class="width-100" value="<?php echo $row['remark']?>">
														<i class="icon-leaf"></i>
													</span>
												</div>
												<div class="help-block col-xs-12 col-sm-reset inline">
	...
	<script type="text/javascript">
		function save() {
			$('#loading').modal('show');
			$.post('/ajax/administrator-edit.php',$('form').serialize(),function(res){
				if (res.tag > 0) {
					$('#loading').modal('hide');
					$('#alert').html(res.html);
					return false;
