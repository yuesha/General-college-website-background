...
<body>
									...
									<div id="edit" class="tab-pane active">
										...
										<form class="form-horizontal" id="sample-form">
												...
												<div class="col-xs-12 col-sm-5 inline help-block">
													<span class="block input-icon input-icon-right">
														<select name="up_id" id="up_id" class="width-100">
															<option>无隶属菜单</option>
															<?php
																$menus = $mysql -> findAll("menus","del_tag = 0 && show_tag = 0");
											...
											<div class="form-group">
												...
												<div class="col-xs-12 col-sm-5 inline help-block">
													<span class="block input-icon input-icon-right">
														<input type="text" name="link_addr" id="link_addr" class="width-100">
														<i class="icon-leaf"></i>
													</span>
												</div>
												<div class="help-block col-xs-12 col-sm-reset inline red">
	...
	<script type="text/javascript">
		function save() {
			$('#loading').modal('show');
			$.post('/ajax/menu_manage-add.php',$('form').serialize(),function(res){
				if (res.tag > 0) {
					$('#loading').modal('hide');
					$('#alert').html(res.html);
					return false;
					...
					setTimeout(function(){
						$('#loading').modal('hide');
						$('#login').text('成功');
						window.location.href="/super/menu_manage-add.php";
					},1000);
				}
			},'json');
			return false;
