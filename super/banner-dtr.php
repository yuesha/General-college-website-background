...
<body>
							...
							<div class="tabbable">
								<ul class="nav nav-tabs" id="myTab">
									...
									<li class="hidden" id="edit_pics">
										<a href="banner-edit.php" id="edit_title">
											编辑横幅图片
										</a>
									</li>
									...
									<div id="lists" class="tab-pane in active">
										...
										<div class="table-responsive">
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													<?php
													$rows = $mysql -> findAll("pics","del_tag=1 && type=2 ORDER BY created_at desc");
													foreach ($rows as $k => $v) {
														?>
														<tr>
															<td class="center">
															...
															<td><img src="<?php echo $v['src'];?>" style="width: 200px;"></td>
															...
															<td>
																<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
																	<button class="btn btn-xs btn-info" onclick="reset(<?php echo $v['id'];?>)">
																		恢复
	...
	<script type="text/javascript">
		function reset(id) {
			...
			if (bool) {
				$('#loading').modal('show');
				$.post('/ajax/banner-reset.php',{'id':id},function(res){
					if (res.tag > 0) {
						$('#loading').modal('hide');
						$('#alert').html(res.html);
						return false;
						...
						setTimeout(function(){
							$('#loading').modal('hide');
							$('#login').text('成功');
							window.location.href="/super/banner-dtr.php";
						},1000);
					}
				},'json');
			}
